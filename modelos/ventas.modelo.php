...
// 	}
	...
	static public function mdlGuardarItem($tabla, $datos){
		
		$stmt = Conexion::conectar()->prepare("INSERT INTO items (idVenta,idCodigoFc,fecha,nombreEscribano,nroComprobante, descripcionComprobante,folio1,folio2) VALUES 
		(:idVenta,:idCodigoFc,:fecha,:nombreEscribano,:nroComprobante, :descripcionComprobante,:folio1,:folio2)");

		$stmt->bindParam(":idVenta", $datos['idVenta'], PDO::PARAM_INT);
		$stmt->bindParam(":idCodigoFc", $datos['idCodigoFc'], PDO::PARAM_INT);
		$stmt->bindParam(":fecha", $datos['fecha'], PDO::PARAM_INT);
		$stmt->bindParam(":nombreEscribano", $datos['nombreEscribano'], PDO::PARAM_STR);
		$stmt->bindParam(":nroComprobante", $datos['nroComprobante'], PDO::PARAM_STR);
		$stmt->bindParam(":descripcionComprobante", $datos['descripcionComprobante'], PDO::PARAM_STR);
		$stmt->bindParam(":folio1", $datos['folio1'], PDO::PARAM_STR);
		$stmt->bindParam(":folio2", $datos['folio2'], PDO::PARAM_STR);
