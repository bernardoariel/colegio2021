 <?php
  ...
  if (isset($_GET['fecha'])){
   ...
   $ventasColorado = ControladorEnlace::ctrRangoFechasEnlace("colorado",$fechaInicial, $fechaFinal);
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1 style="color:red;">
      ...
      Ventas de Colorado de <?php echo $valor;?>
  ...
  <section class="content">
    ...
    <div class="box cajaPrincipal">
      ...
      <div class="col-lg-1">
        ...
        <button class="btn btn-primary" id="bsqlColorado">Buscar</button>

      </div>

      <div class="col-lg-1 pull-left">

        <button class="btn btn-info" id="imprimirColorado" fecha="<?php echo $valor; ?>"><i class="fa fa-print"></i></button>
      ...
      <button type="button" class="btn btn-default pull-right" id="daterange-btn-colorado">
           <span>
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          foreach ($ventasColorado as $key => $value) {
                    ...
                    echo '
                              ...
                              <td>
                                ...
                                <div class="btn-group">
                                  ...
                                  <button class="btn btn-info btnVerVentaColorado" idVenta="'.$value["id"].'" codigo="'.$value["codigo"].'" title="ver la factura" data-toggle="modal" data-target="#modalVerArticulos"><i class="fa fa-eye"></i></button>';
